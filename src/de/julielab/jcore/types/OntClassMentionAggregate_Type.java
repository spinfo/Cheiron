  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (OntClassMentionAggregate_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = OntClassMentionAggregate_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new OntClassMentionAggregate(addr, OntClassMentionAggregate_Type.this);
  			   OntClassMentionAggregate_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new OntClassMentionAggregate(addr, OntClassMentionAggregate_Type.this);
  	  }
    };
  /** @generated */
