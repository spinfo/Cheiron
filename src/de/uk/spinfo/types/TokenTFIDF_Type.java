 ...
 * @generated */
public class TokenTFIDF_Type extends DocumentAnnotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (TokenTFIDF_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = TokenTFIDF_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new TokenTFIDF(addr, TokenTFIDF_Type.this);
  			   TokenTFIDF_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new TokenTFIDF(addr, TokenTFIDF_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = TokenTFIDF.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uk.spinfo.types.TokenTFIDF");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "de.uk.spinfo.types.TokenTFIDF");
  ...
  public double getTfWeight(int addr) {
      ...
      jcas.throwFeatMissing("tfWeight", "de.uk.spinfo.types.TokenTFIDF");
  ...
  public double getTfidfWeight(int addr) {
      ...
      jcas.throwFeatMissing("tfidfWeight", "de.uk.spinfo.types.TokenTFIDF");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "de.uk.spinfo.types.TokenTFIDF");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public TokenTFIDF_Type(JCas jcas, Type casType) {
    super(jcas, casType);
