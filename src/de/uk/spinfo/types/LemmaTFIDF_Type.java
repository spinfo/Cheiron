 ...
 * @generated */
public class LemmaTFIDF_Type extends DocumentAnnotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (LemmaTFIDF_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = LemmaTFIDF_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new LemmaTFIDF(addr, LemmaTFIDF_Type.this);
  			   LemmaTFIDF_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new LemmaTFIDF(addr, LemmaTFIDF_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = LemmaTFIDF.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uk.spinfo.types.LemmaTFIDF");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "de.uk.spinfo.types.LemmaTFIDF");
  ...
  public double getTfWeight(int addr) {
      ...
      jcas.throwFeatMissing("tfWeight", "de.uk.spinfo.types.LemmaTFIDF");
  ...
  public double getTfidfWeight(int addr) {
      ...
      jcas.throwFeatMissing("tfidfWeight", "de.uk.spinfo.types.LemmaTFIDF");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "de.uk.spinfo.types.LemmaTFIDF");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public LemmaTFIDF_Type(JCas jcas, Type casType) {
    super(jcas, casType);
